...
return [
      'theme' => 'default',
  /*
   * The HTML <title> for the generated documentation. If this is empty, Scribe will infer it from config('Wapp.name').
   */
  'title' => null,
  /*
   ...
   */
  'base_url' => 'https://api.dudeisland.eu',
  /*
  ...
  'try_it_out' => [
      ...
      'base_url' => 'https://api.dudeisland.eu',
      /**
       * Fetch a CSRF token before each requesto, and add it as an X-XSRF-TOKEN header. Needed if you're using Laravel Sanctum.
       */
      'use_csrf' => true,
      /**
